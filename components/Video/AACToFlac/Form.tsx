...
const VideoCompressor = () => {
  ...
  const [videoSettings] = useState<videoSettingsInput>({
    ...
    videoType: VideoFormat.FLAC, // Set to MP3 for conversion
    customEndTime: 0,
    customStartTime: 0,
    removeAudio: false,
  });
  ...
  return (
    <>
      {status === "converted" && compressedVideoInfo ? (
        <div className="mt-4">
          <h3 className="text-lg font-bold">Converted Audio Information</h3>
              ...
              <div className="block mt-4">
                ...
                <div>
                  <div className="flex justify-between space-x-2 mt-2">
                    ...
                    >
                      {disableDuringCompression ? "Converting..." : "Convert to FLAC"}
                    </Button>
                  </div>
                </div>
              </div>
