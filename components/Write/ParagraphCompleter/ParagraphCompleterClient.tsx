...
import Form from '@/components/Write/ParagraphCompleter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ParagraphCompleter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ParagraphCompleterClient = () => {
...
export default ParagraphCompleterClient
