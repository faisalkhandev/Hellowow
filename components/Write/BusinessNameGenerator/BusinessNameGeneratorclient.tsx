...
import Form from '@/components/Write/BusinessNameGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/BusinessNameGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const BusinessNameGeneartorClient = () => {
...
export default BusinessNameGeneartorClient
