...
import Form from '@/components/Write/InstagramStoryIdeas/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/InstagramStoryIdeas/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const InstagramStoryIdeasClient = () => {
...
export default InstagramStoryIdeasClient
