...
import Form from '@/components/Write/AITwitterGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/AITwitterGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const AITwitterGeneratorClient = () => {
...
export default AITwitterGeneratorClient
