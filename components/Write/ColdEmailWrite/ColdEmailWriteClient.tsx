...
import Form from '@/components/Write/ColdEmailWrite/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ColdEmailWrite/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ColdEmailWriterClient = () => {
...
export default ColdEmailWriterClient
