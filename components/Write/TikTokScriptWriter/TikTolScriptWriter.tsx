...
import Form from '@/components/Write/TikTokScriptWriter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/TikTokScriptWriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const TikTokScriptWriterClient = () => {
...
export default TikTokScriptWriterClient
