...
import Form from '@/components/Write/ContentSumarizer/Form'
import DownLoadFile from '@/components/Write/ContentSumarizer/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ContentSummarizerClient = () => {
...
export default ContentSummarizerClient
