...
import Form from '@/components/Write/PrivacyPolicyGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/PrivacyPolicyGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const PrivacyPolicyGeneratorClient = () => {
    const [generatedText, setGeneratedText] = useState<string | null>("");
    const [topic, setTopic] = useState<string | null>("");

  
  return (
    <div className='grid max-container grid-cols-1 lg:grid-cols-[.47fr_1fr] gap-6 mt-8 w-full min-h-[500px] lg:px-24'>
...
export default PrivacyPolicyGeneratorClient
