...
import Form from '@/components/Write/LandingPageCopyGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/LandingPageCopyGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const LandingPageCopyGeneratorClient = () => {
...
export default LandingPageCopyGeneratorClient
