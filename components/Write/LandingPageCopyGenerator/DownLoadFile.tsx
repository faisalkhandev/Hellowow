...
interface DownLoadFileProps {
    ...
    topic?:string | null // Define the prop type

}

const DownLoadFile: React.FC<DownLoadFileProps> = ({ generatedText ,topic}) => {
        ...
        <>
            <div className="w-full flex flex-col lg:flex-row items-center gap-3 ">
                ...
                <div className='w-full flex gap-2 items-start'>
                    ...
                    <div className='h-11 px-3 flex justify-center items-center flex-grow-0 flex-shrink-0 rounded-lg bg-[#EFEFEF] text-[#A7A9AA] cursor-pointer' onClick={handleCopyClick}>
