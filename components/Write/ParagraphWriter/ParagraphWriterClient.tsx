...
import Form from '@/components/Write/ParagraphWriter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ParagraphWriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ParagraphWriterClient = () => {
...
export default ParagraphWriterClient
