...
import Form from '@/components/Write/BlogPostRewriter/Form'
import DownLoadFile from '@/components/Write/BlogPostRewriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'
import TriviaEditor from '../TriviGenerator/TextEditor'




const BlogPostRewriterClient = () => {
  ...
  return (
    ...
    <Card className="w-full border-none shadow-lg   ">
      ...
      <CardContent className='space-y-1  flex flex-col pt-6'>
        ...
        <TriviaEditor  generatedText={generatedText} />
...
export default BlogPostRewriterClient
