...
import Form from '@/components/Write/ParagraphRewriter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ParagraphRewriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ParagraphRewriterClient = () => {
...
export default ParagraphRewriterClient
