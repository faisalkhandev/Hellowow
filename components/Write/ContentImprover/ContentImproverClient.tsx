...
import Form from '@/components/Write/ContentImprover/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ContentImprover/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ContentImproverClient = () => {
...
export default ContentImproverClient
