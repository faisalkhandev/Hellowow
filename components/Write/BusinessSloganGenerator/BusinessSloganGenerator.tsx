...
import Form from '@/components/Write/BusinessSloganGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/BusinessSloganGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const BusinessSloganGeneratorClient = () => {
...
export default BusinessSloganGeneratorClient
