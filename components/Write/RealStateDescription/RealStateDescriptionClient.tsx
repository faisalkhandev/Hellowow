...
import Form from '@/components/Write/RealStateDescription/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/RealStateDescription/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const RealStateDescriptionClient = () => {
...
export default RealStateDescriptionClient
