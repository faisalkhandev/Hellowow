...
import Form from '@/components/Write/FacebookADHeadlineGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/FacebookADHeadlineGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const FacebookADHeadlineGeneratorClient = () => {
...
export default FacebookADHeadlineGeneratorClient
