...
import Form from '@/components/Write/PodcastScriptWriter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/PodcastScriptWriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const PodcastScriptWriterClient = () => {
...
export default PodcastScriptWriterClient
