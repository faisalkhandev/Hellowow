...
import Form from '@/components/Write/LinkdinPostGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/LinkdinPostGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const LinkdinPostGeneratorClient = () => {
...
export default LinkdinPostGeneratorClient
