...
import Form from '@/components/Write/PressReleaseGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/PressReleaseGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const PressReleaseGeneratorClient = () => {
...
export default PressReleaseGeneratorClient
