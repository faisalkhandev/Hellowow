...
import Form from '@/components/Write/FAQGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/FAQGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const FAQGeneratorClient = () => {
...
export default FAQGeneratorClient
