...
import Form from '@/components/Write/BlogPostIdeas/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/BlogPostIdeas/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const BlogPostIdeasClient = () => {
...
export default BlogPostIdeasClient
