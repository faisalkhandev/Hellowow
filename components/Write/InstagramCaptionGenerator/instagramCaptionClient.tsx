...
import Form from '@/components/Write/InstagramCaptionGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/InstagramCaptionGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const InstagramCaptionClient = () => {
...
export default InstagramCaptionClient
