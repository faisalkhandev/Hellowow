...
import Form from '@/components/Write/GrammarFixer/Form'
import DownLoadFile from '@/components/Write/GrammarFixer/DownLoadFile'
...
export default GrammarFixerClient
