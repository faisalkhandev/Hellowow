      ...
      {showEditor && generatedText && (
        <div className='grid grid-cols-1  gap-6 mt-8 w-full '>
          {/* <Button
            variant="outline"
            size="lg"
            className="mt-8 font-poppin border border-[#1A8FE3] flex hover:bg-[#126DAF] hover:text-white w-[153px] max-w-[200px] p-0"
            ...
            <div className="rounded-lg p-4">
              ...
              <div className="space-y-4">
                {blogIdeas.aiTitles.map((idea) => (
                  <div key={idea.title} className="flex flex-col  bg-[#F2F2F2] rounded-lg p-2">
            ...
            <div className="rounded-lg p-4">
              ...
              <div className="space-y-4">
                {blogIdeas.searchTitles.map((idea) => (
                  <div key={idea.title} className="flex flex-col my-2 bg-[#F2F2F2] rounded-lg p-2">
