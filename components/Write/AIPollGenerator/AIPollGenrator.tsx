...
import Form from '@/components/Write/AIPollGenerator/Form'
import DownLoadFile from '@/components/Write/EssayWriter/DownLoadFile'
...
export default AIPollGeneratorClient
