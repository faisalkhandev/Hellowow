...
import Form from '@/components/Write/BlogOutline/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/BlogOutline/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const BlogOutlineClient = () => {
...
export default BlogOutlineClient
