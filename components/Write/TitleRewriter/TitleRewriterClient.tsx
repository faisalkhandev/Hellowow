...
import Form from '@/components/Write/TitleRewriter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/TitleRewriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const TitleRewriterClient = () => {
...
export default TitleRewriterClient
