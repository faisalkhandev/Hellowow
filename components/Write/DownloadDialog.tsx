...
export function DownLoadDialog({ generatedText, fileName }: DownLoadDialogProps) {
    const [open, setOpen] = useState(false);
    const [isDisabled, setIsDisabled] = useState(generatedText === null);
    const isDesktop = useMediaQuery("(min-width: 768px)");

    useEffect(() => {
        setIsDisabled(generatedText === null);
    }, [generatedText]);
