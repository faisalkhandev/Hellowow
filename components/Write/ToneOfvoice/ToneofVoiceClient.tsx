...
import Form from '@/components/Write/ToneOfvoice/Form'
import DownLoadFile from '@/components/Write/ToneOfvoice/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ToneofVoiceClient = () => {
...
export default ToneofVoiceClient
