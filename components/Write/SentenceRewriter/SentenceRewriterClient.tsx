...
import Form from '@/components/Write/SentenceRewriter/Form'
import DownLoadFile from '@/components/Write/SentenceRewriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const SentenceRewriterClient = () => {
...
export default SentenceRewriterClient
