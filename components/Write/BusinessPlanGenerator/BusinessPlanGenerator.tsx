...
import Form from '@/components/Write/BusinessPlanGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/BusinessPlanGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const BusinessPlanGeneratorClient = () => {
...
export default BusinessPlanGeneratorClient
