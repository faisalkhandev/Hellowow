...
import Form from '@/components/Write/ArticleRewriter/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ArticleRewriter/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ArticleRewriterClient = () => {
...
export default ArticleRewriterClient
