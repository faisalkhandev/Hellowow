...
import Form from '@/components/Write/TriviGenerator/Form'
import DownLoadFile from '@/components/Write/TriviGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'
import TriviaEditor from './TextEditor'




const TriviGeneratorClient = () => {
...
export default TriviGeneratorClient
