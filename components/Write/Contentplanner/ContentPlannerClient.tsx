...
import Form from '@/components/Write/Contentplanner/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/Contentplanner/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ContentPlannerClient = () => {
...
export default ContentPlannerClient
