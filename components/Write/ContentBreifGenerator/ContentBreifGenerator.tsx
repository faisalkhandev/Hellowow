...
import Form from '@/components/Write/ContentBreifGenerator/Form'
import TextEditor from '@/components/Write/TextEditor'
import DownLoadFile from '@/components/Write/ContentBreifGenerator/DownLoadFile'
import { Card,CardContent,CardFooter } from '@/components/ui/card'




const ContentBriefGeneratorClient = () => {
...
export default ContentBriefGeneratorClient
