...
const PdfSummarizer = () => {
  ...
  return (
    <Card className='w-full lg:w-[944px] h-[450px] shadow-2xl border-none px-4 m-auto'>
      {!files.length && (
        <div className="flex flex-col justify-center items-center space-y-4 h-full max-lg:px-4">
        ...
        {files.length > 0 && (
          <>
            <Card className='border-none rounded-lg p-0'>
              <CardContent className='p-2 border-none shadow-md rounded-lg flex justify-between items-center w-full'>
