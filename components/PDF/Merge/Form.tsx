...
console.log(numPagesArray,"nummPages")
  ...
  return (
    <Card className='w-full lg:w-[944px] m-auto h-[450px] shadow-2xl border-none px-4 max-container'>
      {!files.length && (
        <div className="flex flex-col justify-center items-center space-y-4 max-lg:px-4 h-full w-full">
