  ...
  if (isDesktop) {
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button size="lg" className="w-full max-w-[256px]" >Download <span className="ml-2"><ChevronDown size={16}/></span> </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[256px] " >
       
        <div className="flex flex-col space-y-2">
          <div className="flex gap-2 items-center border-b pb-1 cursor-pointer">
...
return (
  ...
  <Drawer open={open} onOpenChange={setOpen}>
    ...
    <Button size="lg" className="w-full" >Download <span className="ml-2"><ChevronDown size={16}/></span> </Button>
    </DrawerTrigger>
    <DrawerContent>
    <div className="flex flex-col space-y-2">
          <div className="flex gap-2 items-center border-b pb-1 cursor-pointer">
