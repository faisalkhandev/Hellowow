...
console.log(numPagesArray,"nummPages")
  ...
  return (
    <Card className='w-full lg:w-[944px] h-[450px] shadow-2xl border-none'>
      {!files.length && (
        <div className="flex flex-col justify-center items-center space-y-4 max-lg:px-4 h-full">
          <Button onClick={() => fileInputRef.current?.click()} className='flex gap-2 w-full max-w-[320px] text-white font-poppin text-[1rem] font-[600] h-14 '>
