...
const PdfSummarizer = () => {
  ...
  return (
    <>
      {!files.length && (
    <Card className='w-full  h-[450px] shadow-2xl border-none px-4'>

        <div className="flex lg:w-[944px] flex-col justify-center items-center space-y-4 max-lg:px-4 h-full">
