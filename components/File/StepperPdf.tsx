...
interface StepperPdfProps {
  heading: string;
  stepsData: Step[];
}

const StepperPdf = ({ heading, stepsData }: StepperPdfProps) => {

  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-[0.5fr_1fr] items-center ">
