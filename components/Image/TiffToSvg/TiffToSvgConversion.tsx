...
import {convertImageAction} from "@/actions/image/tiffImageConversion"
import DownloadFile from "../DownloadFile";
import { convertImageToSvg } from "@/actions/image/svgConversion";

const TiffToSvgComponent = () => {
  ...
  const handleUpload = async (uploadedFile: File) => {
    ...
    try {
      ...
      const { fileName: processedFileName, base64Image } =
        await convertImageToSvg(formData);
...
export default TiffToSvgComponent;
