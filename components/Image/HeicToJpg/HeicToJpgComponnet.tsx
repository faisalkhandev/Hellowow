...
import { HeicToJpgConversion } from "@/actions/image/imageconversion";
import DownloadFile from "../DownloadFile";

const HeicToJpgComponent = () => {
  ...
  const handleUpload = async (uploadedFile: File) => {
    ...
    try {
      ...
      const convertedImageUrl = await HeicToJpgConversion(base64Image);
  ...
  const getJpegFileName = (originalFileName:string) => {
...
export default HeicToJpgComponent;