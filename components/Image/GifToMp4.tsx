...
import CustomDropzone from '../Video/Custom-dropzone';
...
import { VideoCondenseProgress } from '../Video/VideoCondense';
import { ConvertVideoFile } from '@/utils/convert'; // Import the conversion function

const GifToMp4Component = () => {
  ...
  const [videoSettings] = useState<videoSettingsInput>({
    ...
    videoType: VideoFormat.MP4, // Set to MP3 for conversion
    customEndTime: 0,
    customStartTime: 0,
    removeAudio: false,
  });
  ...
  const condense = async () => {
    ...
    try {
      ...
      setCompressedVideoInfo({
        ...
        size: sizeInMB,
        type: "video/mp4", // Set the type for MP3
      });
              ...
              <div className="block mt-4">
                ...
                <div>
                  <div className="flex justify-between space-x-2 mt-2">
                    ...
                    >
                      {disableDuringCompression ? "Converting..." : "Convert to GIF"}
                    </Button>
                  </div>
                </div>
              </div>
...
export default GifToMp4Component;