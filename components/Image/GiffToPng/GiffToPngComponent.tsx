...
import {  convertImageToPng } from "@/actions/image/imageconversion";

const GifToPngComponent = () => {
  ...
  const handleUpload = async (uploadedFile: File) => {
    ...
    try {
      ...
      const { fileName: processedFileName, base64Image } =
        await convertImageToPng(formData);
...
export default GifToPngComponent;
