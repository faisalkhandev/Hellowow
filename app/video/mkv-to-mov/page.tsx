...
export const metadata: Metadata = {
    title: "Convert MKV to MOV - NifaWow",
    description: "Easily convert MKV video files to MOV format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/MkvToMov/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert MKV to MOV</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert MKV to MOV with our free online tool</p>
                </div>
