...
export const metadata: Metadata = {
    title: "Convert AVI to GIF - NifaWow",
    description: "Easily convert AVI video files to GIF format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/AviToGif/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert AVI to GIF</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert AVI to GIF with our free online tool</p>
                </div>
