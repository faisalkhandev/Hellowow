...
import Rating from '@/components/Video/ToText/Rating';
...
export const metadata: Metadata = {
  title: "Convert Video to Text – Online Transcription Tool | NifaWow",
  description: "Upload your video and effortlessly transcribe it to text with NifaWow’s online tool. Get accurate text conversions quickly and easily.",
};
const FormFile = dynamic(() => import('@/components/Video/ToText/Form'), { ssr: false })
...
const ToText = () => {
  ...
  return (
    ...
    Convert a Video File to Text</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Upload an Video and transcribe to text</p>
    </div>
