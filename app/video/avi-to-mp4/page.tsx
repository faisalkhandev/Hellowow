...
import Rating from '@/components/Video/AviToMp4/Rating';
...
export const metadata: Metadata = {
  title: "AVI to MP4 Converter – Free Online Tool | NifaWow",
  description: "Easily convert AVI video files to MP4 format with NifaWow’s free tool. Enjoy quick and high-quality video conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/AviToMp4/Form'), { ssr: false })
...
const AviToMp4 = () => {
  ...
  return (
    ...
    AVI to MP4</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Upload an AVI and convert to MP4</p>
    </div>
