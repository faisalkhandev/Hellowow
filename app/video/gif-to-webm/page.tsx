...
export const metadata: Metadata = {
    title: "Convert GIF to WEBM - NifaWow",
    description: "Easily convert GIF video files to WEBM format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/GifToWebm/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert GIF to WEBM</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert GIF to WEBM with our free online tool</p>
                </div>
