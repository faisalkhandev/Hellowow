...
export const metadata: Metadata = {
    title: "Convert MOV to WAV - NifaWow",
    description: "Easily convert MOV video files to WAV format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/MovToWav/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert MOV to WAV</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert MOV to WAV with our free online tool</p>
                </div>
