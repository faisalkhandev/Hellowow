...
import Rating from '@/components/Video/Mp4ToGif/Rating';
...
export const metadata: Metadata = {
  title: "MP4 to GIF Converter – Free Online Tool | NifaWow",
  description: "Easily convert MP4 videos to animated GIFs with NifaWow’s free tool. Create high-quality GIFs quickly and effortlessly.",
};
const FormFile = dynamic(() => import('@/components/Video/Mp4ToGif/Form'), { ssr: false })
