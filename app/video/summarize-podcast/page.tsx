...
export const metadata: Metadata = {
    title: "Summarize Podcast - NifaWow",
    description: "Summarize Podcast with our free online tool",
};
const FormFile = dynamic(() => import('@/components/Video/SummarizePodcast/Form'), { ssr: false })

const SummarizePodcast = () => {
    return (
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Summarize Podcast</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Summarize Podcast with our free online tool</p>
                </div>
...
export default SummarizePodcast
