...
import Rating from '@/components/Video/ToWebp/Rating';
...
export const metadata: Metadata = {
  title: "Convert MP4 to WebP – Free Online Tool | NifaWow",
  description: "Easily convert MP4 video files to WebP format with NifaWow’s free tool. Enjoy quick and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/ToWebp/Form'), { ssr: false })
...
const ToWebp = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select a video to convert to WebP format",
        },
        {
          title: "Step 2",
          description: "Upload the video and let our servers go to work",
        },
        {
          title: "Step 3",
          description: "Download the converted WebP file",
        }
       
      ];
      
      const heading = "How To Convert a MP4 to WebP";
  return (
