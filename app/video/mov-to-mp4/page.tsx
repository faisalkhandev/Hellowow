...
import Rating from '@/components/Video/MovToMp4/Rating';
...
export const metadata: Metadata = {
  title: "MOV to MP4 Converter – Free Online Tool | NifaWow",
  description: "Easily convert MOV video files to MP4 format with NifaWow’s free tool. Enjoy quick and high-quality video conversions online.",
};
const FormFile = dynamic(() => import('@/components/Video/MovToMp4/Form'), { ssr: false })
