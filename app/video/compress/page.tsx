...
export const metadata: Metadata = {
  title: "Compress MP4 Video File Size Online – Free Tool by NifaWow",
  description: "Reduce MP4 video file sizes online for free with NifaWow’s easy-to-use video compression tool. Save storage without compromising quality.",
};
const FormFile = dynamic(() => import('@/components/Video/CompressVideo/Form'), { ssr: false })
