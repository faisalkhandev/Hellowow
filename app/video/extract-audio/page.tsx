...
import Rating from '@/components/Video/ExtractAudio/Rating';
...
export const metadata: Metadata = {
  title: "Extract Audio from Video – Free Online Tool | NifaWow",
  description: "Easily extract audio from video files with NifaWow’s free tool. Convert videos to high-quality audio quickly and online.",
};
const FormFile = dynamic(() => import('@/components/Video/ExtractAudio/Form'), { ssr: false })
...
const ExtractAudio = () => {
  ...
  return (
    ...
    Extract Audio from Video</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Extract audio from your video</p>
    </div>
