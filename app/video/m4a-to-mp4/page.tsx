...
export const metadata: Metadata = {
    title: "Convert M4A to MP4 - NifaWow",
    description: "Easily convert M4A audio files to MP4 format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/M4aToMp4/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert M4A to MP4</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert M4A to MP4 with our free online tool</p>
                </div>
