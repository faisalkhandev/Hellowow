...
import Rating from '@/components/Video/OGGToMp3/Rating';
...
export const metadata: Metadata = {
  title: "OGG to MP3 Converter – Free Online Tool | NifaWow",
  description: "Easily convert OGG audio files to MP3 format with NifaWow’s free tool. Enjoy quick and high-quality audio conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/OGGToMp3/Form'), { ssr: false })
...
const OGGToMp3 = () => {
  ...
  return (
    ...
    OGG to MP3 audio</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert OGG to MP3 audio</p>
    </div>
