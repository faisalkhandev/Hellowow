...
export const metadata: Metadata = {
    title: "Convert OGG to WAV - NifaWow",
    description: "Easily convert OGG video files to WAV format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/OGGToWav/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert OGG to WAV</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert OGG to WAV with our free online tool</p>
                </div>
