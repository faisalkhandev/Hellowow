...
export const metadata: Metadata = {
    title: "MP4 to WAV Converter – Free Online Tool | NifaWow",
    description: "Easily convert MP4 video files to WAV format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white ">
                        Convert MP4 to WAV</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert MP4 to WAV with our free online tool</p>
                </div>
