...
export const metadata: Metadata = {
    title: "Convert MOV to AVI - NifaWow",
    description: "Easily convert MOV video files to AVI format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert MOV to AVI</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert MOV to AVI with our free online tool</p>
                </div>
