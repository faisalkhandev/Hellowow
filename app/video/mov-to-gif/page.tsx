...
import Rating from '@/components/Video/MovToGif/Rating';
...
export const metadata: Metadata = {
  title: "MOV to Animated GIF Converter – Free Online Tool | NifaWow",
  description: "Easily convert MOV video files to animated GIFs with NifaWow’s free tool. Create high-quality GIFs quickly and effortlessly online.",
};
const FormFile = dynamic(() => import('@/components/Video/MovToGif/Form'), { ssr: false })
...
const MovToGif = () => {
  ...
  return (
    ...
    MOV to GIF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Upload an MOV and convert to animated GIF</p>
    </div>
