...
export const metadata: Metadata = {
    title: "Convert MKV to AVI - NifaWow",
    description: "Easily convert MKV video files to AVI format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/MkvToAvi/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert MKV to AVI</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert MKV to AVI with our free online tool</p>
                </div>
