...
import Rating from '@/components/Video/Resize/Rating';
...
export const metadata: Metadata = {
  title: "Resize Video Resolution Online – Free Tool | NifaWow",
  description: "Easily resize your videos online with NifaWow’s free tool. Adjust video resolution quickly and effortlessly for any format.",
};
const FormFile = dynamic(() => import('@/components/Video/Resize/Form'), { ssr: false })
...
const Resize = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select a video to modify the resolution",
        },
        {
          title: "Step 2",
          description: "Upload the video and input a new resolution",
        },
        {
          title: "Step 3",
          description: "Download the video in it's new resolution",
        }
       
      ];
      
      const heading = "How To Resize the Aspect Ratio of a Video";
  return (
    ...
    Resize Video Resolution</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Resize a video&apos;s resolution and maintain aspect ratio</p>
    </div>
