...
export const metadata: Metadata = {
    title: "Convert AAC to WAV - NifaWow",
    description: "Easily convert AAC audio files to WAV format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/AACToWav/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert AAC to WAV</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert AAC to WAV with our free online tool</p>
                </div>
