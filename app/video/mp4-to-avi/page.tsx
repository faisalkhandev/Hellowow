...
import Rating from '@/components/Video/Mp4ToAvi/Rating';
...
export const metadata: Metadata = {
  title: "MP4 to AVI Converter – Free Online Tool | NifaWow",
  description: "Easily convert MP4 video files to AVI format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/MovToAvi/Form'), { ssr: false })
...
const Mp4ToAvi = () => {
  ...
  return (
    ...
    MP4 to AVI</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Upload an MP4 and convert to AVI</p>
    </div>
