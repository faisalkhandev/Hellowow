...
export const metadata: Metadata = {
    title: "Convert MP4 to OGG - NifaWow",
    description: "Easily convert MP4 video files to OGG format with NifaWow’s free tool. Enjoy fast and high-quality conversions online, hassle-free.",
};
const FormFile = dynamic(() => import('@/components/Video/Mp4ToOgg/Form'), { ssr: false })
            ...
            <div className='max-container'>
                <div className='text-center'>
                    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">
                        Convert MP4 to OGG</h1>
                    <p className='text-paragraph font-poppin text-[1rem]'>Convert MP4 to OGG with our free online tool</p>
                </div>
