...
export const metadata: Metadata = {
    title: "Compress MOV Video File Size Online – Free Tool by NifaWow",
    description: "Reduce MOV video file sizes online for free with NifaWow’s easy-to-use video compression tool. Save storage without compromising quality.",
};
const FormFile = dynamic(() => import('@/components/Video/CompressMov/Form'), { ssr: false })
