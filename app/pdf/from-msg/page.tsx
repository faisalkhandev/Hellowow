...
import Rating from '@/components/PDF/MsgToPdf/Rating';
...
export const metadata: Metadata = {
  title: "Convert .MSG to PDF - NifaWow",
  description: "Upload your MS Outlook file and download it as a PDF using our free online tool.",
};
const FormFile = dynamic(() => import('@/components/PDF/MsgToPdf/Form'), { ssr: false })
...
const MsgToPdf = () => {
  ...
  return (
    ...
    Convert .MSG to PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Upload a MS Outlook file an Download as a PDF</p>
    </div>
