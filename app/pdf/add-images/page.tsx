...
import Rating from '@/components/PDF/AddImages/Rating';
...
export const metadata: Metadata = {
  title: "Add Images to PDF - NifaWow",
  description: "Use our free online tool to easily add images to your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/AddImages/Form'), { ssr: false })
...
const AddImages = () => {
  ...
  return (
    ...
    Add images to PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Add images to PDF</p>
    </div>
