...
import Rating from '@/components/PDF/Tiff/Rating';
...
export const metadata: Metadata = {
  title: "TIFF to PDF - NifaWow",
  description: "Use our free online tool to quickly convert TIFF files into PDF format.",
};
const FormFile = dynamic(() => import('@/components/PDF/Tiff/Form'), { ssr: false })
