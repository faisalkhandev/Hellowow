...
import Rating from '@/components/PDF/TextToPdf/Rating';
...
export const metadata: Metadata = {
  title: "Add Text to PDF - NifaWow",
  description: "Use our free online tool to easily add text to your PDF files."}
const FormFile = dynamic(() => import('@/components/PDF/TextToPdf/Form'), { ssr: false })
...
const TextToPdf = () => {
  ...
  return (
    ...
    Add Text to PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Add Text to PDF</p>
    </div>
