...
import Rating from '@/components/PDF/FromWord/Rating';
...
export const metadata: Metadata = {
  title: "Delete Pages from a PDF - Free Online Tool - NifaWow",
  description: "Use our free online tool to easily delete pages from your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/Delete/Form'), { ssr: false })
...
const Delete = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Upload a PDF file to our servers",
        },
        {
          title: "Step 2",
          description: "Manually select the pages to delete or enter the page numbers below.",
        },
        {
          title: "Step 3",
          description: "Generate & download a new PDF file with the selected pages deleted.",
        },
        
      ];
      
      const heading = "How To Delete Pages from a PDF";
  return (
    ...
    Delete Pages from a PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Delete Pages from PDF</p>
    </div>
