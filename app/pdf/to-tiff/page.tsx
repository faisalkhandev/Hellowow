...
import Rating from '@/components/PDF/ToTiff/Rating';
...
export const metadata: Metadata = {
  title: "Convert a PDF to TIFF Images - NifaWow",
  description: "Use our free online tool to easily convert PDF files into TIFF images."}
const FormFile = dynamic(() => import('@/components/PDF/ToTiff/Form'), { ssr: false })
...
const Tiff = () => {
  ...
  return (
    ...
    Convert a PDF to TIFF Images</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert PDF to TIFF and download each page as an image</p>
    </div>
