...
export const metadata: Metadata = {
  title: "Convert PDF to Excel - Free Online Tool - NifaWow",
  description: "Use our free online tool to quickly convert PDF files into Excel spreadsheets.",
};
const FormFile = dynamic(() => import('@/components/PDF/Xlsx/Form'), { ssr: false })
...
const Excel = () => {
  ...
  return (
    ...
    PDF To Excel</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Extract data and convert PDF to XLSX</p>
    </div>
