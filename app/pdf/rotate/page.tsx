...
import Rating from '@/components/PDF/RotatePdf/Rating';
...
export const metadata: Metadata = {
  title: "Rotate PDF File Pages Online Free - NifaWow",
  description: "Use our free online tool to easily rotate the pages of your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/RotatePdf/Form'), { ssr: false })
...
const Rotate = () => {
    const stepsData = [
        ...
        {
          title: "Step 2",
          description: "Select a PDF document with pages that need rotating",
        },
        {
          title: "Step 3",
          description: "Upload a PDF document with one or more pages",
        },
      
      ];
      
      const heading = "How To Rotate Pages in a PDF File";
  return (
    ...
    Rotate PDF Pages</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Rotate one or more pages in a PDF file</p>
    </div>
