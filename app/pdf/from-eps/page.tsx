...
import Rating from '@/components/PDF/FromEps/Rating';
...
export const metadata: Metadata = {
  title: "EPS to PDF - NifaWow",
  description: "UUse our free online tool to easily convert EPS files into PDF format.",
};
const FormFile = dynamic(() => import('@/components/PDF/FromEps/Form'), { ssr: false })
