...
import Rating from '@/components/PDF/CSV/Rating';
...
export const metadata: Metadata = {
  title: "PDF to CSV - NifaWow",
  description: "Use our free online tool to quickly convert PDF files into CSV format.",
};
const FormFile = dynamic(() => import('@/components/PDF/CSV/Form'), { ssr: false })
...
const CSV = () => {
  ...
  return (
    ...
    PDF To CSV</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Extract tables from PDF to CSV</p>
    </div>
