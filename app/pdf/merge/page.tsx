...
export const metadata: Metadata = {
  title: "Combine PDF Files Online for Free - NifaWow",
  description: "Easily merge multiple PDF files into one with NifaWow's free online tool. Fast, secure, and user-friendly. No registration required!",
};

const FormFile = dynamic(() => import('@/components/PDF/Merge/Form'), { ssr: false })
...
const MergePage = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select 2 or more PDF documents to upload to our system.",
        },
        {
          title: "Step 2",
          description: "Upload the PDF files from a PC or smartphone.",
        },
        {
          title: "Step 3",
          description: "Click 'Merge' to combine the selected PDF files.",
        },
        {
          title: "Step 4",
          description: "Download your new PDF.",
        },
      ];
      
      const heading = "How To Merge/Combine PDF Files";
  return (
    ...
    Merge PDF Files</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Merge 2 or more PDF files into a single PDF file</p>
    </div>
