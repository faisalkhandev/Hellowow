...
import Rating from '@/components/PDF/FromGif/Rating';
...
export const metadata: Metadata = {
  title: "GIF to PDF - NifaWow",
  description: "Use our free online tool to quickly convert GIF files into PDF format.",
};
const FormFile = dynamic(() => import('@/components/PDF/FromGif/Form'), { ssr: false })
