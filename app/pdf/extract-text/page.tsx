...
import Rating from '@/components/PDF/ExtractText/Rating';
...
export const metadata: Metadata = {
  title: "Extract Text from PDF Document - NifaWow",
  description: "Use our free online tool to easily extract text from your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/ExtractText/Form'), { ssr: false })
...
const ExtractText = () => {
  ...
  return (
    ...
    Extract text from PDF document</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Extract text from PDF document</p>
    </div>
