...
export const metadata: Metadata = {
  title: "Compress PDF File Size Online Free - NifaWow",
  description: "Use NifaWow's free tool to compress PDF file size quickly and easily. No sign-up required, accessible from any device.",
};
const FormFile = dynamic(() => import('@/components/PDF/Compress/Form'), { ssr: false })
...
const Compress = () => {
  ...
  return (
    ...
    Compress PDF File Size</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Lessen the file size of a PDF file</p>
    </div>
