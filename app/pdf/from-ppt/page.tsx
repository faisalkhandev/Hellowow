...
import Rating from '@/components/PDF/FromPPT/Rating';
...
export const metadata: Metadata = {
  title: "Convert a PowerPoint Presentation to PDF Online Free - NifaWow",
  description: "Use our free online tool to effortlessly convert PowerPoint presentations into PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/FromPPT/Form'), { ssr: false })
...
const FromPPT = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select a PowerPoint document to convert to PDF format",
        },
        {
          title: "Step 2",
        ...
        {
          title: "Step 3",
          description: "Download the converted PPT as PDF",
        }
       
      ];
      
      const heading = "How To Convert a PowerPoint .PPT to a PDF";
  return (
    ...
    Convert .PPT to PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Upload a Powerpoint presentation an Download as a PDF</p>
    </div>
