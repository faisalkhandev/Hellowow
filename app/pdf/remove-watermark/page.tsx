...
import Rating from '@/components/PDF/RemoveWaterMark/Rating';
...
export const metadata: Metadata = {
  title: "Remove the Watermark from a PDF - Free Online Tool - NifaWow",
  description: "Use our free online tool to effortlessly remove watermarks from your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/RemoveWaterMark/Form'), { ssr: false })
...
const RemoveWaterMark = () => {
  ...
  return (
    ...
    Remove Watermark from PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Remove Watermark from PDF</p>
    </div>
