...
import Rating from '@/components/PDF/Mobi/Rating';
...
export const metadata: Metadata = {
  title: "MOBI to PDF - NifaWow",
  description: "Use our free online tool to quickly convert MOBI files into PDF format.",
};
const FormFile = dynamic(() => import('@/components/PDF/Mobi/Form'), { ssr: false })
...
const Mobi = () => {
  ...
  return (
    ...
    MOBI to PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert MOBI file to PDF file</p>
    </div>
