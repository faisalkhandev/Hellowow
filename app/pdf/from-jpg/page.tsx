...
export const metadata: Metadata = {
  title: "Convert JPG Image(s) to PDF Online Free - NifaWow",
  description: "Use NifaWow's free tool to easily convert JPG images to PDF files. No sign-up required, fast and accessible from any device.",
};
const FormFile = dynamic(() => import('@/components/PDF/JpgToPdf/Form'), { ssr: false })
...
const JpgPage = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select one or more JPG images",
        },
        {
          title: "Step 2",
          description: "Upload to our servers for processing",
        },
        {
          title: "Step 3",
          description: "Generate the PDF file and download with each image on a different page",
        }
       
      ];
      
      const heading = "How To Create a PDF File from JPG Images";
  return (
