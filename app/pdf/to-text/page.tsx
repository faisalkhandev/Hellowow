...
import Rating from '@/components/PDF/PdfToText/Rating';
...
export const metadata: Metadata = {
  title: "Convert a PDF to Text Free Online with OCR - NifaWow",
  description: "Use our free online tool to easily convert PDF files to text using OCR technology.",
};
const FormFile = dynamic(() => import('@/components/PDF/PdfToText/Form'), { ssr: false })
  ...
  return (
      ...
      <div className='text-center'>
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">
          Convert PDF to Text</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Convert PDF to Text</p>
      </div>
