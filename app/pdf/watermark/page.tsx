...
import Rating from '@/components/PDF/WaterMark/Rating';
...
export const metadata: Metadata = {
  title: "Add Watermark - NifaWow",
  description: "Use our free online tool to easily add watermarks to your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/WaterMark/Form'), { ssr: false })
...
const Watermark = () => {
  ...
  return (
    ...
    Add Watermark</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Stamp an image over your PDF</p>
    </div>
