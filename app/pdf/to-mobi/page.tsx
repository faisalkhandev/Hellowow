...
import Rating from '@/components/PDF/PdfToMobi/Rating';
...
export const metadata: Metadata = {
  title: "PDF to MOBI - NifaWow",
  description: "Use our free online tool to quickly convert PDF files into MOBI format.",
};
const FormFile = dynamic(() => import('@/components/PDF/PdfToMobi/Form'), { ssr: false })
...
const MobiPdf = () => {
  ...
  return (
    ...
    PDF to MOBI</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert PDF file to MOBI file</p>
    </div>
