...
import Rating from '@/components/PDF/ToWord/Rating';
import React from 'react'
import dynamic from 'next/dynamic'
import StepperPdf from '@/components/PDF/StepperPdf';
import { Metadata } from 'next'

export const metadata: Metadata = {
  title: "Convert PDF to Word Document Free Online Tool - NifaWow",
  description: "Use our free online tool to quickly and easily convert PDF files into editable Word documents.",
};
const FormFile = dynamic(() => import('@/components/PDF/ToWord/Form'), { ssr: false })
...
const MergePage = () => {
  const stepsData = [
    ...
    {
      title: "Step 2",
      description: "Select and start processing",
    },
    {
      title: "Step 3",
      description: "Download the converted Word document",
    },
  ];

  
  const heading = "How To Convert a PDF to a Word Doc Free";
  ...
  return (
    ...
    Convert PDF to Word</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Extract the Text from a PDF Document to a Word File</p>
    </div>
    ...
    <div className='pt-11'>
      <StepperPdf heading={heading} stepsData={stepsData} />;
      </div>
    </div>
    </div>
  )
