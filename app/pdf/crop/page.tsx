...
import Rating from '@/components/PDF/Crop/Rating';
...
export const metadata: Metadata = {
  title: "Crop PDF - NifaWow",
  description: "Use our free online tool to easily crop your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/Crop/Form'), { ssr: false })
...
const Crop = () => {
  ...
  return (
    ...
    Crop PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Free PDF cropper</p>
    </div>
