...
import Rating from '@/components/PDF/PdfToAzw3/Rating';
...
export const metadata: Metadata = {
  title: "PDF to AZW3 - NifaWow",
  description: "Use our free online tool to quickly convert PDF files into AZW3 format.",
};
const FormFile = dynamic(() => import('@/components/PDF/PdfToAzw3/Form'), { ssr: false })
...
const Azw3 = () => {
  ...
  return (
    ...
    PDF to AZW3</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert PDF file to AZW3 file</p>
    </div>
