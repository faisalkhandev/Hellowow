...
import Rating from '@/components/PDF/Annotate/Rating';
...
export const metadata: Metadata = {
  title: "Annotate PDF - NifaWow",
  description: "Use our free online tool to easily annotate your PDF files.",
};
const FormFile = dynamic(() => import('@/components/PDF/Annotate/Form'), { ssr: false })
