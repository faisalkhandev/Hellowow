...
export const metadata: Metadata = {
  title: "Convert a Word .DOC to PDF Online Free - NifaWow",
  description: "Use our free tool to effortlessly convert Word documents (.DOC) to PDF files online.",
};
const FormFile = dynamic(() => import('@/components/PDF/FromWord/Form'), { ssr: false })
...
const MergePage = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select a Word document that needs converting to PDF",
        },
        {
          title: "Step 2",
      ...
      const heading = "How To Convert a Word Document to a PDF";
  return (
