...
import Rating from '@/components/PDF/PdfToPng/Rating';
...
export const metadata: Metadata = {
  title: "Convert a PDF to PNG Images - NifaWow",
  description: "Use our free online tool to easily convert PDF files into PNG images.",
};
const FormFile = dynamic(() => import('@/components/PDF/PdfToPng/Form'), { ssr: false })
...
const PngPage = () => {
  ...
  return (
    ...
    Convert a PDF to PNG Images</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert PDF to PNG and download each page as an image</p>
    </div>
