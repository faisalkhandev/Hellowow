...
import Rating from '@/components/PDF/Sign/Rating';
...
export const metadata: Metadata = {
  title: "E-sign a PDF File for Free (No Sign-Up Required) - NifaWow",
  description: "Use our tool to easily e-sign your PDF files for free, with no sign-up required.",
};
const FormFile = dynamic(() => import('@/components/PDF/Sign/Form'), { ssr: false })
...
const MergePage = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select & upload a PDF file that needs a signature",
        },
        {
          title: "Step 2",
          description: "Digitally sign or select a handwritten font and place on PDF"
        },
        {
          title: "Step 3",
          description: "Download the signed PDF",
        },
       
      ];
      
      const heading = "How To Sign a PDF from a PC or Phone";
  return (
    ...
    Digitally Sign a PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>E-sign a PDF with a font or with your signature</p>
    </div>
