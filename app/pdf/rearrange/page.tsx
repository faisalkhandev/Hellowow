...
export const metadata: Metadata = {
  title: "Rearrange PDF Pages Free Tool - No Sign Up - NifaWow",
  description: "Use our free tool to easily rearrange the pages of your PDF files, no sign-up required.",
};
const FormFile = dynamic(() => import('@/components/PDF/Rearrange/Form'), { ssr: false })
...
const Rearrange = () => {
  ...
  return (
    ...
    Rearrange PDF Pages</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Rearrange the pages of a PDF file</p>
    </div>
