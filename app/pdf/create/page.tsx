...
import Rating from '@/components/PDF/CreatePdf/Rating';
...
export const metadata: Metadata = {
  title: "Create PDF - NifaWow",
  description: "Use our free online tool to easily create PDF files from your documents.",
};
const FormFile = dynamic(() => import('@/components/PDF/CreatePdf/Form'), { ssr: false })
...
const EditPdf = () => {
  ...
  return (
    ...
    Edit PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Free PDF Editor</p>
    </div>
