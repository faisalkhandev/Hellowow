...
import CollageMakerClient from '@/components/Image/CollageMaker/CollageMaker';


export const metadata: Metadata = {
    title: "Collage Maker - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white ">Collage Maker</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Create Photo Collages Online</p>
            </div>
