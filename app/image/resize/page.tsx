...
import ResizeImageComponent from '@/components/Image/ResizeImage/ImageResizeComponent';


export const metadata: Metadata = {
    title: "Resize Image - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Resize an Image or Photo</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Let our tool quickly modify your image dimensions</p>
            </div>
