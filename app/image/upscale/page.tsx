...
import UpscaleImageComponent from '@/components/Image/UpscaleImage/UpscaleImage';


export const metadata: Metadata = {
    title: "Upscale Image - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white ">Upscale an Image</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Increase the resolution from your PC, iPhone or Android device</p>
            </div>
            <div className=' mt-8 w-full md:px-28'>
                <UpscaleImageComponent />
            </div>
