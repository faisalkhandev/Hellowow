...
import CompressImageComponent from '@/components/Image/CompressImage/CompressedImageComponent';


export const metadata: Metadata = {
    title: "Compress Image - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Image Compressor</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Compress JPGs, PNGs, GIFs and more</p>
            </div>
