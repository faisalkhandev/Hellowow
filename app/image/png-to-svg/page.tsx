...
export const metadata: Metadata = {
    title: "Convert PNG to SVG - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white">Convert PNG to SVG</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Convert PNG to SVG with our free online tool</p>
            </div>
