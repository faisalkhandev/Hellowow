...
import JpgToWebpComponent from '@/components/Image/JpgToWebp/JpgToWebpComponent';


export const metadata: Metadata = {
    title: "Convert JPG to WebP - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-qwhite">Convert JPG to WebP</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Convert JPG to WebP with our free online tool</p>
            </div>
