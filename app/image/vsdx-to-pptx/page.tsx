...
export const metadata: Metadata = {
    title: "Convert VSDX to PPTX - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white">Convert VSDX to PPTX</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Convert VSDX to PPTX with our free online tool</p>
            </div>
