...
import BeforeAfterSlider from '@/components/Image/BackgroundRemover/BeforeAfterSlider';


export const metadata: Metadata = {
    title: "Remove Background From Image - NifaWow",
        ...
        <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">
                    Remove the Background From an Image</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Easily Remove the Background from an image</p>
            </div>
