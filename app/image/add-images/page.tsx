...
import AddImageComponent from '@/components/Image/AddImages/AddImagesComponent';


export const metadata: Metadata = {
    title: "Add Image(s) to an Image - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white">Add Image(s) to an Image</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Add one or more images to another image</p>
            </div>
