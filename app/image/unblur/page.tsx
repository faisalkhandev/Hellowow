...
import UnblurImageComponent from '@/components/Image/UnblurImage/UnblurImageComponent';


export const metadata: Metadata = {
    title: "Unblur Image - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white">Unblur Image</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Unblur Image online</p>
            </div>
            <div className='mt-8 w-full md:px-28'>
             <UnblurImageComponent/>
            </div>
