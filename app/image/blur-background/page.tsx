...
import BlurImageUpload from '@/components/Image/BlurBackground/BlurBackground';


export const metadata: Metadata = {
    title: "Blur Background - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white ">Blur Background</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Automatically blur the background on an image</p>
            </div>
