...
import FlipUpload from '@/components/Image/Flip/FlipUpload';


export const metadata: Metadata = {
    title: "Image Flipper - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white">Image Flipper</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Flip your image horizontally or vertically</p>
            </div>
