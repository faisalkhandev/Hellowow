...
import JpgToAvifComponent from '@/components/Image/JpgToAvif/JpgToAvifComponent';


export const metadata: Metadata = {
    title: "Convert JPG to AVIF - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16 space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold font-poppin text-heading dark:text-white">Convert JPG to AVIF</h1>
                <p className='text-paragraph font-poppin text-[1rem]'>Convert JPG to AVIF with our free online tool</p>
            </div>
