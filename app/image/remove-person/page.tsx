...
import RemoveObjectUpload from '@/components/Image/RemoveObject/RemoveObjectUpload';


export const metadata: Metadata = {
    title: "Remove Person - NifaWow",
    ...
    return (
        <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
            <div className='text-center'>
                <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Remove a Person from a Photo</h1>
                <p className='text-paragraph font-poppin  text-[1rem]'>Remove one or multiple people from a photo</p>
            </div>
