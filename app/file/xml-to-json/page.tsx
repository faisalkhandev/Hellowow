...
import Editor from "@/components/File/XmlToJson/Editor"
...
export const metadata: Metadata = {
  title: "Excel to XML - NifaWow",
  description: "Use our free online tool to quickly convert Excel files into XML format."}
...
const XmlToJson = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select an XML file and convert to JSON",
        },
        {
          title: "Step 2",
          description: "Upload the XML formatted file to our servers",
        },
        {
          title: "Step 3",
      ...
      const heading = "How To Convert an XML File to JSON";
  return (
    ...
    XML to JSON</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert XML to JSON</p>
    </div>
