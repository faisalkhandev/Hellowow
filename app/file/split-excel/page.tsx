...
import Rating from '@/components/File/SplitExcel/Rating';
import React from 'react'

import dynamic from 'next/dynamic'

const FormFile = dynamic(() => import('@/components/File/SplitExcel/Form'), { ssr: false })
import { Metadata } from 'next'


export const metadata: Metadata = {
  title: "Split Excel File - NifaWow",
  description: "Use our free online tool to easily split Excel files into separate sheets."}
...
const SplitExcel = () => {
  ...
  return (
    ...
    Split Excel file</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Split into one or multiple Excel files</p>
    </div>
