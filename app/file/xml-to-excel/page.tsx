...
import Editor from "@/components/File/XmlToExcel/Editor"
...
export const metadata: Metadata = {
  title: "Convert an XML to Excel Online Free - NifaWow",
  description: "Use our free online tool to easily convert XML files to Excel format."}
...
const XmlToExcel = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select a XML file and convert to Excel",
        },
        {
          title: "Step 2",
          description: "Upload the XML file to our servers",
        },
        {
          title: "Step 3",
      ...
      const heading = "How To Convert a XML to Excel";
  return (
    ...
    XML to Excel</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert XML to Excel</p>
    </div>
