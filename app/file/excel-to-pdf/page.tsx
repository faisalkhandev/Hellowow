...
const FormFile = dynamic(() => import('@/components/File/ExcelToPdf/Form'), { ssr: false })
import { Metadata } from 'next'


export const metadata: Metadata = {
  title: "Excel to PDF - NifaWow",
  description: "Use our free online tool to quickly convert Excel files into PDF format."}
...
const ExcelToPdf = () => {
  ...
  return (
    ...
    Excel to PDF</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert Excel to PDF</p>
    </div>
