...
import Rating from '@/components/File/ExcelToXml/Rating';
...
const FormFile = dynamic(() => import('@/components/File/ExcelToXml/Form'), { ssr: false })
...
const ExcelToXml= () => {
  ...
  return (
    ...
    Excel to XML</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert Excel to XML</p>
    </div>
