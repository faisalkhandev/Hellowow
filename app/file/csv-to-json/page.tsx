...
import Editor from "@/components/File/CsvToJson/Editor"
...
export const metadata: Metadata = {
  title: "Convert a CSV to JSON Online Free - NifaWow",
  description: "Use our free online tool to easily convert CSV files to JSON format."}
...
const CsvToJson = () => {
    const stepsData = [
        {
          title: "Step 1",
          description: "Select a CSV and convert to JSON",
        },
        {
          title: "Step 2",
          description: "Upload the CSV file to our servers for processing",
        },
        {
          title: "Step 3",
      ...
      const heading = "How To Convert a CSV to JSON";
  return (
    
        <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
          <div className='max-container'>
      <div className='text-center'>
    <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading ">
    CSV to JSON</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Convert CSV to JSON</p>
    </div>
