...
import Rating from '@/components/File/CsvToXml/Rating';
import Editor from "@/components/File/CsvToXml/Editor"
...
export const metadata: Metadata = {
  title: "Convert a CSV to XML Online Free - NifaWow",
  description: "Use our free online tool to easily convert CSV files to XML format."
}
...
const CsvToXml = () => {
  const stepsData = [
    {
      title: "Step 1",
      description: "Select a CSV and convert to XML",
    },
    {
      title: "Step 2",
  ...
  const heading = "How To Convert a CSV to XML";
  return (
    ...
    <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      ...
      <div className='text-center'>
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">
          CSV to XML</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Convert CSV to XML</p>
      </div>
