...
import Rating from '@/components/File/SplitCsv/Rating';
import React from 'react'

import dynamic from 'next/dynamic'

const FormFile = dynamic(() => import('@/components/File/SplitCsv/Form'), { ssr: false })
import { Metadata } from 'next'


export const metadata: Metadata = {
  title: "Split CSV Online Free - NifaWow",
  description: "Use our free online tool to easily split CSV files into smaller sections."}
...
const SplitCsv = () => {
  ...
  return (
    ...
    Split CSV file</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Split into one or multiple CSV files</p>
    </div>
