...
import Rating from '@/components/Write/InstagramStoryIdeas/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import InstagramStoryIdeasClient from '@/components/Write/InstagramStoryIdeas/InstagramStoryIdeasClient'


export const metadata: Metadata = {
  title: "Instagram Story Ideas - NifaWow",
  description: "Generate creative Instagram story ideas tailored to your account's theme. Share engaging content with your audience effortlessly.",
};


const InstagramStoryideas = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        Instagram Story Ideas</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate instagram story ideas for you</p>
        </div>
        {/* <div className='grid grid-cols-1 max-container md:grid-cols-[fr_1.2fr] gap-6 mt-8 w-full min-h-[624px] md:px-24'>
          <Form />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Instagram Story Idea') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default InstagramStoryideas