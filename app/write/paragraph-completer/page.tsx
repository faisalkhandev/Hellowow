...
import Rating from '@/components/Write/ParagraphCompleter/Rating'
import QrCode from '@/components/Write/QrCode'
import ParagraphCompleterClient from '@/components/Write/ParagraphCompleter/ParagraphCompleterClient'

const ParagraphCompleter = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-4 padding-x">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Paragraph Completer</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Paragraph Completer</p>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Paragraph Completer') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default ParagraphCompleter