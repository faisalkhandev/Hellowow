...
import Rating from '@/components/Write/StoryGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import StoryGeneratorClient from '@/components/Write/StoryGenerator/StoryGeneratorClient'



export const metadata: Metadata = {
  title: "AI Story Generator - Create Stories with AI - NifaWow",
  description: "Let AI generate creative stories for you. Use the NifaWow story generator for free and bring your ideas to life.",
};


const StoryGenratorPage = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading dark:text-white ">Story Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Give us a topic and we&apos;ll write a story</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Story Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default StoryGenratorPage