...
import Rating from '@/components/Write/PodcastScriptWriter/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import PodcastScriptWriterClient from '@/components/Write/PodcastScriptWriter/PodcastScriptWriter'


export const metadata: Metadata = {
  title: "Free AI Podcast Script Writer - NifaWow",
  description: "Generate engaging podcast scripts with AI. Enter your topic and let us help you create a well-structured script in seconds.",
};


const PodcastScriptWriter = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        Podcast Script Writer</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Let AI Generate a Podcast Script</p>
        </div>
        {/* <div className='grid grid-cols-1 max-container md:grid-cols-[.5fr_1fr] gap-6 mt-8 w-full min-h-[624px] md:px-24'>
          <Form />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Content Paraphraser') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default PodcastScriptWriter