...
import Rating from '@/components/Write/AITwitterGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import AITwitterGeneratorClient from '@/components/Write/AITwitterGenerator/AiTwitterGeneratorClient'


export const metadata: Metadata = {
  title: "AI Twitter Generator - NifaWow",
  description: "Generate engaging Twitter posts with AI. Enter your topic and tone, and let AI write the perfect tweet for you.",
};


const AITwitterGenerator = () => {
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        AI Twitter Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Twitter Generator</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Twitter Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default AITwitterGenerator