...
import Rating from '@/components/Write/PressReleaseGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import PressReleaseGeneratorClient from '@/components/Write/PressReleaseGenerator/PressReleaseGenerator'

export const metadata: Metadata = {
  title: "Press Release Generator - Generate PR with AI - NifaWow",
  description: "Easily create professional press releases with AI. Provide your company name and purpose to generate a polished press release in seconds.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        Press Release Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate a press release with AI</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Press Release Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
