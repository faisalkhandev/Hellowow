...
import Rating from '@/components/Write/BusinessPlanGenerator/Rating'
...
export const metadata: Metadata = {
  title: "Business Plan Generator - NifaWow",
  description: "Generate a comprehensive business plan tailored to your business idea. Enter your business details and let AI create your plan.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Business Plan Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>
        Generate business plan for you</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Business Plan Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
