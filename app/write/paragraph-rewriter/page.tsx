...
import Rating from '@/components/Write/ParagraphRewriter/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ParagraphRewriterClient from '@/components/Write/ParagraphRewriter/ParagraphRewriterClient'

export const metadata: Metadata = {
  title: "AI Paragraph Rewriter - Rewrite and Rephrase - NifaWow",
  description: "Let AI rewrite and rephrase your paragraphs to improve clarity, tone, and style. Perfect for professionals, students, and writers looking for new ideas.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Paragraph Rewriter</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Let AI Rewrite & Rephrase a Paragraph</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Paragraph Rewriter') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
