...
import Rating from '@/components/Write/ContentSumarizer/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ContentSummarizerClient from '@/components/Write/ContentSumarizer/ContentSummarizerClient'


export const metadata: Metadata = {
  title: "AI Content Summarizer - Summarize Content Instantly - NifaWow",
  description: "Summarize large blocks of content or URLs with our AI-powered content summarizer. Free and easy to use.",
};


const ContentSumarizer = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">AI Content Summarizer</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Summarize a block of content or a URL</p>
        </div>
        <ContentSummarizerClient/>
...
export default ContentSumarizer