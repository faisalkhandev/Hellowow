...
import Rating from '@/components/Write/FacebookADHeadlineGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import FacebookADHeadlineGeneratorClient from '@/components/Write/FacebookADHeadlineGenerator/FacebookADHeadlineGeneartor'


export const metadata: Metadata = {
  title: "Facebook Ad Headline Generator - NifaWow",
  description: "Generate attention-grabbing headlines for your Facebook ads. Enter details about your company and what it does to create impactful headlines.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        Facebook Ad Headline Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate facebook ad headlines for your company</p>
        </div>
        {/* <div className='grid grid-cols-1 max-container md:grid-cols-[0.67fr_1.2fr] gap-6 mt-8 w-full min-h-[624px] md:px-24'>
          <Form />
        ...
        <FacebookADHeadlineGeneratorClient/>
        <QrCode />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'FB Headline Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
