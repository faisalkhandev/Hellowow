...
import Rating from '@/components/Write/Translate/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next/types'
import TranslateClient from '@/components/Write/Translate/TranslateClient'

export const metadata: Metadata = {
  title: "AI Text Translation - Free Translate to English, Spanish, French & Portuguese - NifaWow",
  description: "Let AI translate your text to different languages such as English, Spanish, French, or Portuguese. Free and easy to use with no sign-up.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        Let AI Translate your Text to a Different Language</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Translate') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
