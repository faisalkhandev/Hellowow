...
import {Form} from '@/components/Write/AIPostWriter/Form'
import Rating from '@/components/Write/AIPostWriter/Rating'
  ...
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-4 padding-x">
        ...
        AI Post Writer</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate an SEO optimized blog post</p>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Post Writer') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
