...
import Rating from '@/components/Write/MetaDescriptionGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import MetaDescriptionClient from '@/components/Write/MetaDescriptionGenerator/MetaDescriptionGeneratorClient'

export const metadata: Metadata = {
  title: "Meta Description Generator - NifaWow",
  description: "Generate SEO-optimized meta descriptions for your article or webpage. Enter your title, and let AI generate a compelling description.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Meta Description Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>
        Generator meta description for your article</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Meta Description Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
