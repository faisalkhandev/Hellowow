...
import RephraserClient from '@/components/Write/Repharaser/RephraserClient'
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        AI Rephraser</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>AI Rephraser Content</p>
        </div>
        {/* <div className='grid grid-cols-1 md:grid-cols-[.5fr_1.2fr] gap-6 mt-8 w-full min-h-[624px] md:px-24 max-container'>
          <Form />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'AI Rephraser') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
