...
import Form from '@/components/Write/BillPay/Form'
...
export const metadata: Metadata = {
  title: "Bill of Sale Generator - NifaWow",
  description: "Create a legally sound bill of sale for your transactions. Generate a bill of sale quickly and easily with our online tool.",
};
...
const BillSale = () => {
  return (
    ...
    Bill of Sale Generator</h1>
    <p className='text-paragraph font-poppin  text-[1rem]'>Generate bill of sale for your</p>
    
     </div>
     <div className=' mt-8 w-full  md:px-28 max-container'>
    <Form />
    ...
    <div className='w-full py-8'>
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Bill of Sale') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
