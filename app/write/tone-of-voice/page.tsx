...
import Rating from '@/components/Write/ToneOfvoice/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ToneofVoiceClient from '@/components/Write/ToneOfvoice/ToneofVoiceClient'


export const metadata: Metadata = {
  title: "Tone of Voice Generator - Customize Writing Tone - NifaWow",
  description: "Generate content in your preferred tone of voice. Input your topic, and let our AI adjust the tone for professional, casual, or any style you need.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Tone of Voice</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Tone of Voice Tool</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Tone of Voice') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
