...
import Rating from '@/components/Write/BlogOutline/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ContentBriefGeneratorClient from '@/components/Write/ContentBreifGenerator/ContentBreifGenerator'


export const metadata: Metadata = {
  title: "Content Brief Generator - NifaWow",
  description: "Generate a concise content brief for your article. Let AI help you create structured and well-organized briefs for your content.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Content Brief Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>
        Generator content brief for you article title</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Content Brief Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
