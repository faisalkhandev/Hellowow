...
import Rating from '@/components/Write/ContentShortener/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ContentShortnerClient from '@/components/Write/ContentShortener/ContentShortnerClient'

export const metadata: Metadata = {
  title: "AI Content Shortener - Free No Sign-Up - NifaWow",
  description: "Resize your content to a new length. Shorten sentences, paragraphs, or longer text blocks effortlessly using AI. No sign-up required.",
};




const ContentShortener = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        Content Shortener</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Resize your content to a new length</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Content Shortener') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default ContentShortener