...
import Rating from '@/components/Write/ExplainIt/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ExplainItClient from '@/components/Write/ExplainIt/ExplainItClient'




export const metadata: Metadata = {
  title: "AI Explain It Like I'm Five - Make the Complex Simple - NifaWow",
  description: "Easily explain complex topics in simple terms with AI. Enter your topic and let us break it down in a way even a youngster can understand.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Explain it</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Explain a Topic So a Youngster Can Understand</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Explain it') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
