...
import Rating from '@/components/Write/LandingPageCopyGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import LandingPageCopyGeneratorClient from '@/components/Write/LandingPageCopyGenerator/LandingPageCopyGenerator'



export const metadata: Metadata = {
  title: "Generate Landing Page Copy with AI - NifaWow",
  description: "Create compelling landing page copy for your website. Enter your company name and purpose, and let AI generate effective copy for you.",
};


const LandingPageCopyGenerator = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        Landing Page Copy Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate landing page copy for your website</p>
        </div>
        {/* <div className='grid max-container grid-cols-1 md:grid-cols-[.5fr_1fr] gap-6 mt-8 w-full min-h-[624px] md:px-24'>
          <Form />
        ...
        <LandingPageCopyGeneratorClient/>
        <QrCode />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Landing Page Copy Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
