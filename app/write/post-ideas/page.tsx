...
import Rating from '@/components/Write/BlogPostIdeas/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import BlogPostIdeasClient from '@/components/Write/BlogPostIdeas/BlogPostIdeasClient'


export const metadata: Metadata = {
  title: "Blog Post Ideas - Generate Ideas for Your Blog - NifaWow",
  description: "Generate fresh blog post ideas based on your topic and audience. Let AI brainstorm and create content ideas for your blog with ease.",
};
      ...
      <div className='text-center'>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Blog Post Ideas') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
