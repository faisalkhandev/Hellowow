...
import Rating from '@/components/Write/ContentImprover/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ContentImproverClient from '@/components/Write/ContentImprover/ContentImproverClient'

export const metadata: Metadata = {
  title: "AI Content Improver - Enhance Your Writing - NifaWow",
  description: "Improve your content quality instantly with our AI-powered content improver. Free to use with no sign-up required.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">AI Content Improver</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Improve the quality of your content</p>
        </div>
        <ContentImproverClient/>
