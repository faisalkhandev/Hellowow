...
import Rating from '@/components/Write/InstagramCaptionGenerator/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import InstagramCaptionClient from '@/components/Write/InstagramCaptionGenerator/instagramCaptionClient'


export const metadata: Metadata = {
  title: "Instagram Caption Generator - AI-Powered Captions - NifaWow",
  description: "Generate Instagram captions effortlessly with our AI tool. Input your topic, and get captions in seconds to boost your social media presence.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Instagram Caption Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate instagram caption for your</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Instagram Caption Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
