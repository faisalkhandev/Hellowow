...
import Rating from '@/components/Write/ArticleRewriter/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import {Form} from "@/components/Write/ArticleWriter/Form"

export const metadata: Metadata = {
  title: "AI Article Rewriter - Free Article Rewriting Tool - NifaWow",
  description: "Rephrase your article with AI in seconds. Let us help you generate a fresh version of your article with a single click.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className="text-center">
        ...
        Article Rewriter</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Rephrase an article</p>
        </div>
        <Form/>
        <QrCode />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Article Rewriter') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
