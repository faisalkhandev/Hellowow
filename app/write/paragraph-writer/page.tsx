...
import Rating from '@/components/Write/ParagraphWriter/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ParagraphWriterClient from '@/components/Write/ParagraphWriter/ParagraphWriterClient'


export const metadata: Metadata = {
  title: "AI Paragraph Writer - Generate Paragraphs Instantly - NifaWow",
  description: "Generate high-quality paragraphs in seconds using our free AI paragraph writer tool on NifaWow.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x ">
      ...
      <div className="text-center">
        <h1 className="text-[1.6rem] sm:text-[40px] font-bold  font-poppin text-heading  dark:text-white ">Paragraph Writer</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Let AI Generate a Paragraph For You</p>
        </div>
        <div className=' w-full min-h-[624px] md:px-24'>
           <ParagraphWriterClient/>
          {/* <div className='max-container grid grid-cols-1 md:grid-cols-[.47fr_1fr] gap-6 mt-8'>
          <Form />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Paragraph Writer') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
