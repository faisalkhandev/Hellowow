...
import Rating from '@/components/Write/RealStateDescription/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import RealStateDescriptionClient from '@/components/Write/RealStateDescription/RealStateDescriptionClient'


export const metadata: Metadata = {
  title: "Free Real Estate Description Generator - NifaWow",
  description: "Generate eye-catching real estate descriptions with AI. Enter your property details, and let AI write an attractive listing for you.",
};


const RealStateDescription = () => {
  return (
    <>
...
Real Estate Description Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>
        Give us the facts, we&apos;ll right an eye-catching description</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Real Estate Descriptions') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default RealStateDescription