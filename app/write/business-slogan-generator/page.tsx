...
import BusinessSloganGeneratorClient from '@/components/Write/BusinessSloganGenerator/BusinessSloganGenerator'


export const metadata: Metadata = {
  title: "Business Slogan Generator - NifaWow",
  description: "Generate catchy slogans for your business with AI. Enter your business details, and let us create unique slogan ideas for you.",
};


const BusinessSlogen = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        Business Slogan Generator</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Generate business slogan for you</p>
        </div>
       
        <BusinessSloganGeneratorClient/>
        <QrCode />
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Business Slogan Generator') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
