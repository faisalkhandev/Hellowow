...
import Rating from '@/components/Write/ContentParaphraser/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import ContentPharaphraseClient from '@/components/Write/ContentParaphraser/ContentParaphraserClient'

export const metadata: Metadata = {
  title: "Free AI Content Paraphraser - NifaWow",
  description: "Let AI paraphrase your content quickly and efficiently. Enter your article, and let us rewrite it in seconds with unique wording.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        Content Paraphraser</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Let AI Paraphrase your Content</p>
        </div>
