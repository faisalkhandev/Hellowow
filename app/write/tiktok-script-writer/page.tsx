...
import Rating from '@/components/Write/TikTokScriptWriter/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import TikTokScriptWriterClient from '@/components/Write/TikTokScriptWriter/TikTolScriptWriter'

export const metadata: Metadata = {
  title: "AI TikTok Script Writer - Free - NifaWow",
  description: "Create captivating TikTok scripts quickly. Enter your topic and let AI help you craft the perfect script to engage your audience.",
};


const TikTokScriptWriter = () => {
  return (
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        TikTok Script Writer</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>TikTok Script Generator</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'TikTok Script Writer') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
...
export default TikTokScriptWriter