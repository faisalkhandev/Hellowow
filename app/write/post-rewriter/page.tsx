...
import Rating from '@/components/Write/BlogPostRewriter/Rating'
import QrCode from '@/components/Write/QrCode'
import { Metadata } from 'next'
import BlogPostRewriterClient from '@/components/Write/BlogPostRewriter/BlogPostRewriterClient'

export const metadata: Metadata = {
  title: "Blog Post Rewriter - NifaWow",
  description: "Rewrite and rephrase your blog posts with AI. Improve your content's clarity and engagement in seconds with our rewriter tool.",
};
    ...
    <>
     <div className="w-full flex flex-col justify-center items-center py-16  space-y-8 padding-x">
      <div className='text-center'>
        ...
        Blog Post Rewriter</h1>
        <p className='text-paragraph font-poppin  text-[1rem]'>Rewrite and Rephrase a Blog Post</p>
        </div>
        ...
        <div className="max-container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8  ">
            {aiWritingToolsArray
              .filter(card => card.title !== 'Blog Post Rewriter') 
              .slice(0, 8) 
              .map((card, index) => (
                <MainToolCard
                  key={index}
